...
1: open the command prompt or terminal on the local computer "cd" to the working repository

2: "git clone" [this repository url] To clone the current repository into the local repository

3: "cd combined_healthbook" To see the project source code location under folder "combined_healthbook"

4: "npm install" To install the required modules inside "combined_healthbook" folder
